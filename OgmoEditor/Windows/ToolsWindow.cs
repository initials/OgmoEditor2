...
namespace OgmoEditor.Windows
{
    public class ToolsWindow : OgmoWindow
    {
            ...
            : base(HorizontalSnap.Right, VerticalSnap.Top)
        {
            ...
            toolsForLayerTypes.Add(typeof(GridLayerDefinition), new Tool[] { new GridPencilTool(), new GridFloodTool(), new GridRectangleTool(), new GridLineTool(), new GridSelectionTool(), new GridMoveSelectionTool(), new GridCaveTool() });
            toolsForLayerTypes.Add(typeof(TileLayerDefinition), new Tool[] { new TilePencilTool(), new TileEyedropperTool(), new TileFloodTool(), new TileRectangleTool(), new TileLineTool(), new TileSelectionTool(), new TileMoveSelectionTool(), new TileCaveTool() });
